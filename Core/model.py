...
class model_train_seq_LSTM :
    ...
    def save_model(self, model_path = 'C:/Users/TATHAGATA GHOSH/Desktop/LSTM_Project/Core/lstm_pretrained.h5') :
        """Saves the trained model to a file."""
        self.model.save(model_path)
        print(f"Model saved to {model_path}")

    def load_model(self, model_path = 'C:/Users/TATHAGATA GHOSH/Desktop/LSTM_Project/Core/lstm_pretrained.h5') :
